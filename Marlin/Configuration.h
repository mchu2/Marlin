...
#define STRING_CONFIG_H_AUTHOR "Easy" // Original author or contributor.
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 17.27f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.1798f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.1642f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.1700f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
...
//#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 27.65
  #define DEFAULT_bedKi 3.93
  #define DEFAULT_bedKd 129.7
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -46, -15, -1.35 }
...
#define PREHEAT_6_LABEL       "PA6-CF"
#define PREHEAT_6_TEMP_HOTEND 280
#define PREHEAT_6_TEMP_BED    45
